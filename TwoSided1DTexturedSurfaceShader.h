...
class TwoSided1DTexturedSurfaceShader:public GLObject
	...
	/* New methods: */
	void set(int colorTextureUnit,SceneGraph::GLRenderState& renderState) const; // Sets up two-sided 1D-textured surface using the given color texture unit for the given render state
	};
