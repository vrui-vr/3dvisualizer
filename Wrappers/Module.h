...
class Module:public Visualization::Abstract::Module
	...
	virtual Collab::DataType::TypeID createScalarAlgorithmParametersType(int scalarAlgorithmIndex,Collab::DataType& dataType) const;
	#endif
	...
	#if VISUALIZATION_CONFIG_USE_COLLABORATION
	virtual Collab::DataType::TypeID createVectorAlgorithmParametersType(int vectorAlgorithmIndex,Collab::DataType& dataType) const;
	#endif
