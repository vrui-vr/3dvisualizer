...
class DataSetRenderer:public Visualization::Abstract::DataSetRenderer,public GLObject
	...
	/* Methods from class Abstract::DataSetRenderer: */
	...
	virtual void highlightLocator(const Visualization::Abstract::DataSet::Locator* locator,SceneGraph::GLRenderState& renderState) const;
