...
class VolumeRenderingSampler
	...
	Size3 samplerSize; // Optimal size of the resulting Cartesian volume
	...
	/* Methods: */
	const Size3& getSamplerSize(void) const // Returns the size of the resulting Cartesian volume
		{
		return samplerSize;
		}
