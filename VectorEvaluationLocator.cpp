...
const char* VectorEvaluationLocator::getClassName(void) const
	{
	return "3DVisualizer::VectorEvaluationLocator";
	}

void VectorEvaluationLocator::glRenderAction(SceneGraph::GLRenderState& renderState) const
	{
	/* Call the base class method: */
	EvaluationLocator::glRenderAction(renderState);
