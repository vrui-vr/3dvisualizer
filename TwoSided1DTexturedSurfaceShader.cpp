...
void TwoSided1DTexturedSurfaceShader::DataItem::buildShader(GLLightTracker& lt,GLClipPlaneTracker& cpt)
	{
	/* Reset the shader: */
	shader.reset();
...
void TwoSided1DTexturedSurfaceShader::set(int colorTextureUnit,SceneGraph::GLRenderState& renderState) const
	{
