...
void TripleChannelRaycaster::initDataItem(Raycaster::DataItem* dataItem) const
	...
	glTexImage3DEXT(GL_TEXTURE_3D_EXT,0,GL_RGB8,myDataItem->textureSize,0,GL_RGB,GL_UNSIGNED_BYTE,0);
...
void TripleChannelRaycaster::bindShader(const Raycaster::PTransform& pmv,const Raycaster::PTransform& mv,SceneGraph::GLRenderState& renderState,Raycaster::DataItem* dataItem) const
	{
	/* Call the base class method: */
	...
	if(myDataItem->volumeTextureVersion!=dataVersion)
		...
		glTexSubImage3DEXT(GL_TEXTURE_3D_EXT,0,dataSize,GL_RGB,GL_UNSIGNED_BYTE,data);
...
void TripleChannelRaycaster::unbindShader(SceneGraph::GLRenderState& renderState,Raycaster::DataItem* dataItem) const
	{
...
TripleChannelRaycaster::TripleChannelRaycaster(const Raycaster::Size3& sDataSize,const Raycaster::Box& sDomain)
	:Raycaster(sDataSize,sDomain),
	 data(new Voxel[dataSize.volume()*3]),dataVersion(0)
	{
