...
void BaseLocator::highlightLocator(SceneGraph::GLRenderState& renderState) const
	{
	/* Render nothing */
	}

void BaseLocator::renderLocator(SceneGraph::GLRenderState& renderState) const
	{
	/* Render nothing */
	}

void BaseLocator::renderLocatorTransparent(SceneGraph::GLRenderState& renderState) const
	{
	/* Render nothing */
	}
