...
#ifndef VISUALIZATION_CONCRETE_UNSTRUCTRUREDHEXAHEDRALXDMF_INCLUDED
#define VISUALIZATION_CONCRETE_UNSTRUCTRUREDHEXAHEDRALXDMF_INCLUDED
...
class UnstructuredHexahedralXdmf:public BaseModule
	{
	/* Constructors and destructors: */
	public:
	UnstructuredHexahedralXdmf(void); // Default constructor
