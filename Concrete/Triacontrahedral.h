...
#ifndef VISUALIZATION_CONCRETE_TRIACONTRAHEDRAL_INCLUDED
#define VISUALIZATION_CONCRETE_TRIACONTRAHEDRAL_INCLUDED
...
class Triacontrahedral:public BaseModule
	{
	/* Constructors and destructors: */
	public:
	Triacontrahedral(void); // Default constructor
