...
#ifndef VISUALIZATION_CONCRETE_UNSTRUCTRUREDHEXAHEDRALVTKXML_INCLUDED
#define VISUALIZATION_CONCRETE_UNSTRUCTRUREDHEXAHEDRALVTKXML_INCLUDED
...
class UnstructuredHexahedralVTKXML:public BaseModule
	{
	/* Constructors and destructors: */
	public:
	UnstructuredHexahedralVTKXML(void); // Default constructor
