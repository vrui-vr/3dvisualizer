...
void Algorithm::setSeedLocator(const DataSet::Locator* seedLocator)
	{
	/* Signal an error: */
	throw Misc::makeStdErr(__PRETTY_FUNCTION__,"No seeded element creation method defined");
	}
...
Element* Algorithm::createElement(Parameters* extractParameters)
	...
	/* Signal an error: */
	throw Misc::makeStdErr(__PRETTY_FUNCTION__,"No immediate element creation method defined");
	return 0;
	}
...
Element* Algorithm::startElement(Parameters* extractParameters)
	...
	/* Signal an error: */
	throw Misc::makeStdErr(__PRETTY_FUNCTION__,"No incremental element creation methods defined");
	return 0;
	}
